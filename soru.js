...
let sorular = [
    ...
    new Soru("2 Hüma Ar-Ge bünyesinde kaç takım teknofeste hazırlanmıştır ve hazırlanmaktadır?(2024 dahil)", { a: "16", b: "20", c: "26", d: "36" }, "c"),
    ...
    new Soru("13-UR5 Robot Kol için kaç kg filament harcanmıştır ? (Hatalı baskılar dahil)", { a: "4kg", b: "7kg", c: "10kg" , d: "14kg" }, "c"),
    ...
    new Soru("16-Hasan staj zamanında aşağıdaki yemek ikililerinden hangisini yemiştir ?", { a: "Tiramisu-Icetea", b: "Çökertme Kebabı-Çay", c: "Pizza-Kola", d: "Trabzon Ekmeği-Sigara" }, "d"),
